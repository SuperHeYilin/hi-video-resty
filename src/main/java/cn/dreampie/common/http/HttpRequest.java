...
import cn.dreampie.common.http.AbstractRequest;
...
public class HttpRequest extends AbstractRequest {
  ...
  public void SetQueryParams(String k,Object v) {
	  setqueryParams.put(k,new String[]{v.toString()});
  }
  private Map<String, String[]> setqueryParams=new HashMap<String, String[]>();
  protected Map<String, String[]> getParamMap() {
	  Map<String, String[]> map=new HashMap<String, String[]>();
	  map.putAll(request.getParameterMap());
	  map.putAll(setqueryParams);
    return map;
  }
